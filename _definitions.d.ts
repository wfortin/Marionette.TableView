...
/// <reference path="definitions/backbone.picky.d.ts" />
/// <reference path="definitions/jquery.d.ts" />
/// <reference path="definitions/marionette.d.ts" />
/// <reference path="definitions/underscore.d.ts" />
/// <reference path="definitions/underscore.string.d.ts" />

/// <reference path="views/GroupRowView.ts" />
...
/// <reference path="collections/GroupableCollection.ts" />
